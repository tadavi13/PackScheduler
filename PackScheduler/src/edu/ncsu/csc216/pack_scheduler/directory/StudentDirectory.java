...
public class StudentDirectory {
	 ...
	 * @throws IllegalArgumentException if it is not able to read the file given
	 */
	 ...
	 * @throws IllegalArgumentException if password or repeat password is null or an empty string
	 * @throws IllegalArgumentException if the passwords do not equal each other
	...
	/**
	 * Gets student in student directory with same given id 
