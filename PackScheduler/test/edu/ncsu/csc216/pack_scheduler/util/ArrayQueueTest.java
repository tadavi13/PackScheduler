...
/**
 * Class contains test methods for ArrayQueue
 * @author Chris Brown
 * @author Tyler Davis
 * @author Ken Ogura
 */
class ArrayQueueTest {
	...
	/** Array Queue 1 for use in test methods */
	private ArrayQueue<String> q1;
	/** Array Queue 2 for use in test methods */
	private ArrayQueue<String> q2;
	/** Array Queue 2 for use in test methods */
	private ArrayQueue<String> q3;
	...
	@BeforeEach
	public void setUp() {
		q1 = new ArrayQueue<String>(10);
		q2 = new ArrayQueue<String>(10);
		q3 = new ArrayQueue<String>(10);
	}
